...
CREATE TABLE "new_Prescription" (
    ...
    "notified" INTEGER NOT NULL DEFAULT 10000,
...
INSERT INTO "new_Prescription" ("customerId", "id", "notes", "prescription", "renewalDate") SELECT "customerId", "id", "notes", "prescription", "renewalDate" FROM "Prescription";
